      ...
      <div className="w-full max-w-sm">
        ...
        <div className="card p-8 space-y-4">
          <div className="text-center mb-2">
            <div className="text-text-secondary text-sm">Ingresá con tu cuenta Google</div>
          </div>

          {hasError && (
            <div className="text-loss text-sm bg-loss-muted border border-loss/20 rounded-lg px-4 py-3 text-center">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white hover:bg-gray-50 text-gray-700 font-medium rounded-lg border border-gray-200 transition-all duration-200 hover:shadow-md active:scale-95"
          >
            <GoogleIcon />
